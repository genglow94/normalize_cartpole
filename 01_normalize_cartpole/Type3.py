...
import time
from MMP import Type3_02  # ← あなたのネットワーク
...
for mode in modes:
    ...
    for seed in range(num_seeds):
        ...
        q_net = Type3_02(obs_dim, n_actions)
        target_net = Type3_02(obs_dim, n_actions)
...
plt.title("Restricted Normalization Type3_02 DQN")
plt.xlabel("Episode")
