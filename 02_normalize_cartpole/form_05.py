...
for mode in modes:
    ...
    for seed in range(num_seeds):
        ...
        # ======== ネットワーク ========
        q_net = form_05(obs_dim, n_actions).to(device)
        target_net = form_05(obs_dim, n_actions).to(device)
...
plt.title("Restricted Normalization form_05 DQN")
plt.xlabel("Episode")
