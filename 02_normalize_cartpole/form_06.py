...
for mode in modes:
    ...
    for seed in range(num_seeds):
        ...
        # ======== ネットワーク ========
        q_net = form_06(obs_dim, n_actions).to(device)
        target_net = form_06(obs_dim, n_actions).to(device)
        ...
        for episode in range(num_episodes):
            ...
            if episode % 100 == 0 and len(buffer) >= batch_size:
                ...
                if mode in ["max_only", "both"]:
                    ...
                    q_net.max2.restricted_normalize(D, g_func_min1, g_func_max2)
...
plt.title("Restricted Normalization form_06 DQN")
plt.xlabel("Episode")
